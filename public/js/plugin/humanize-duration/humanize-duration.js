...
;(function() {
  ...
  var LANGUAGES = {
    ...
    et: {
      year: function(c) { return "aasta" + ((c !== 1) ? "" : ""); },
      month: function(c) { return "kuu" + ((c !== 1) ? "" : ""); },
      week: function(c) { return "nädala" + ((c !== 1) ? "" : ""); },
      day: function(c) { return "päeva" + ((c !== 1) ? "" : ""); },
      hour: function(c) { return "tunni" + ((c !== 1) ? "" : ""); },
      minute: function(c) { return "minuti" + ((c !== 1) ? "" : ""); },
      second: function(c) { return "sekundi" + ((c !== 1) ? "" : ""); },
      millisecond: function(c) { return "millisekundi" + ((c !== 1) ? "" : ""); }
    },
    ca: {
